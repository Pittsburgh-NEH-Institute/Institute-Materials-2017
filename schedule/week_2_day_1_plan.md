...
25 min | Tag ["Oxymandias"](ozymandias.txt) in XML (e.g., lines, sentences, phrases, speakers, words, feet, syllables, stress) | Code lab
...
Time | Topic | Type
---- | ---- | ---- 
10 min | [Review of Week 2, Day 1 Modeling and communities](week_2_day_1_plan.md) | Discussion
35 min | [XPath](xpath.md) as a way of navigating [the tree](hamlet.xml) | Code lab
