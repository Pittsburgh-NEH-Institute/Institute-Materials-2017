...
* For Windows: **Windows Powershell**, which you can find from the search box. The Windows 10 Anniversary Edition also supports **bash**, which is preferable if you can run it (see [How to install and use the Linux bash shell on Windows 10](https://www.howtogeek.com/249966/how-to-install-and-use-the-linux-bash-shell-on-windows-10/) and our note about [how to find your files](windows_bash.md) for details). Although **cmd.exe** is the traditional Windows shell, and you may even have used it previously, we recommend **bash** if you are able to run it on your version of Windows, and **Windows Powershell** otherwise.
